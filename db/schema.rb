...
ActiveRecord::Schema.define(version: 20200302173838) do
  ...
  create_table "congratulations_videos", force: :cascade do |t|
    t.string "name"
    t.string "file"
    t.string "cover"
    t.string "slug"
  ...
  create_table "happy_birthday_videos", force: :cascade do |t|
    t.string "name"
    t.string "file"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "slug"
    t.string "cover"
    t.index ["name"], name: "index_happy_birthday_videos_on_name", unique: true
  end
