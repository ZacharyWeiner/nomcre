...
class ExternalLinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create external_link" do
    assert_difference('ExternalLink.count') do
      post external_links_url, params: { external_link: { title: @external_link.title, url: @external_link.url } }
    end
  ...
  test "should update external_link" do
    patch external_link_url(@external_link), params: { external_link: { title: @external_link.title, url: @external_link.url } }
