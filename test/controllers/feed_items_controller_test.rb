...
class FeedItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feed_item" do
    assert_difference('FeedItem.count') do
      post feed_items_url, params: { feed_item: { body: @feed_item.body, description: @feed_item.description, title: @feed_item.title } }
    end
  ...
  test "should update feed_item" do
    patch feed_item_url(@feed_item), params: { feed_item: { body: @feed_item.body, description: @feed_item.description, title: @feed_item.title } }
