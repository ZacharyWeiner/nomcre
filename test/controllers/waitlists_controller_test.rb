...
class WaitlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waitlist" do
    assert_difference('Waitlist.count') do
      post waitlists_url, params: { waitlist: { email: @waitlist.email, facebook: @waitlist.facebook, instagram: @waitlist.instagram, name: @waitlist.name, phone: @waitlist.phone, px500: @waitlist.px500, smugmug: @waitlist.smugmug, website: @waitlist.website } }
    end
  ...
  test "should update waitlist" do
    patch waitlist_url(@waitlist), params: { waitlist: { email: @waitlist.email, facebook: @waitlist.facebook, instagram: @waitlist.instagram, name: @waitlist.name, phone: @waitlist.phone, px500: @waitlist.px500, smugmug: @waitlist.smugmug, website: @waitlist.website } }
