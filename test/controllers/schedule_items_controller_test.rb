...
class ScheduleItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule_item" do
    assert_difference('ScheduleItem.count') do
      post schedule_items_url, params: { schedule_item: { end_date: @schedule_item.end_date, location_id: @schedule_item.location_id, notes: @schedule_item.notes, start_date: @schedule_item.start_date, user_id: @schedule_item.user_id } }
    end
  ...
  test "should update schedule_item" do
    patch schedule_item_url(@schedule_item), params: { schedule_item: { end_date: @schedule_item.end_date, location_id: @schedule_item.location_id, notes: @schedule_item.notes, start_date: @schedule_item.start_date, user_id: @schedule_item.user_id } }
