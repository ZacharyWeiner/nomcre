...
class TaskGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_group" do
    assert_difference('TaskGroup.count') do
      post task_groups_url, params: { task_group: { approver_id: @task_group.approver_id, complete: @task_group.complete, shoot_id: @task_group.shoot_id, title: @task_group.title } }
    end
  ...
  test "should update task_group" do
    patch task_group_url(@task_group), params: { task_group: { approver_id: @task_group.approver_id, complete: @task_group.complete, shoot_id: @task_group.shoot_id, title: @task_group.title } }
